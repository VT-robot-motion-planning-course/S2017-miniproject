...
if("TRUE" STREQUAL "TRUE")
  set(beginner_tutorials_SOURCE_PREFIX /home/aravind/ROS_MINI_PROJECT/src/scan_point_cloud)
  set(beginner_tutorials_DEVEL_PREFIX /home/aravind/ROS_MINI_PROJECT/devel)
  ...
  set(beginner_tutorials_INSTALL_PREFIX /home/aravind/ROS_MINI_PROJECT/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'technologic <aravindp@vt.edu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aravind/ROS_MINI_PROJECT/src/scan_point_cloud/${idir}'.  Ask the maintainer 'technologic <aravindp@vt.edu>' to fix it.")
    endif()
